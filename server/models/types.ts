...
export interface CulturalEventDoc {
  ...
  title: string;
  slug: string;
  category: 'festival' | 'moulid' | 'exhibition' | 'workshop' | 'cultural_night' | 'market_fair' | 'harvest' | string;
  governorateName: string;
  governorateId: string;
  cityName?: string;
  villageName?: string;
...
/* =========================================================
   REPORT & COMPLAINT SYSTEM (نظام البلاغات والشكاوى)
   ========================================================= */
...
export interface ReportTicketDocument {
  _id?: string;
  id: string;
  ticketNumber: string;
  userId: string;
