...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: 'https://res.cloudinary.com/kuana1nl/image/upload/v1788711341/لوجو_وه_copy.png',
  },
  openGraph: {
    title: 'وه | WAH — الحكاية ورا كل حاجة',
    description:
  ...
  twitter: {
    ...
    description:
      'منصة صعيد مصر الشاملة: سوق حرفي تجاري متكامل للتسوق المباشر، ريلز وتجارب صناع المحتوى الحية، وتوثيق وثائقي تفاعلي لمعالم وتراث محافظات الصعيد.',
    images: ['https://res.cloudinary.com/kuana1nl/image/upload/v1788711341/لوجو_وه_copy.png'],
  },
};
  ...
  return (
    <html lang="ar" dir="rtl">
      <head>
        ...
        <link rel="preload" as="image" href="https://res.cloudinary.com/kuana1nl/image/upload/v1788711341/لوجو_وه_copy.png" type="image/png" />
