...
export const api = {
  ...
  // استرجاع صور المعرض التراثي السحابي (Cloudinary) لورش الصعيد
  async fetchCloudinaryImages(): Promise<Array<{ id?: string; title?: string; url: string; secure_url?: string; public_id?: string; region?: string; craft?: string }>> {
