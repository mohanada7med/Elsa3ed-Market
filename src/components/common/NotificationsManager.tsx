...
export const NotificationsManager: React.FC<NotificationsManagerProps> = ({
  ...
  const getNotificationIcon = (type: NotificationType) => {
    switch (type) {
      ...
      default:
        return <Bell className="w-5 h-5 text-[#B24C2B]" />;
    }
  };
  ...
  return (
    <div className="space-y-6 animate-in fade-in">
      ...
      <div className="bg-white dark:bg-[#1E1917] p-5 sm:p-6 rounded-3xl border border-[#E5DDD3] dark:border-[#352B24] shadow-xs">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-5 border-b border-[#F0EBE4] dark:border-[#2E2520]">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-[#73675B] dark:text-[#A89C90] max-w-2xl leading-relaxed">
          ...
          <div className="flex items-center gap-3 shrink-0 flex-wrap">
            {browserNotificationPermission === 'granted' ? (
              <button
                ...
                className="px-4 py-2.5 bg-[#FAF7F2] dark:bg-[#26201C] hover:bg-[#F3EFE9] dark:hover:bg-[#2D2420] text-[#B24C2B] dark:text-[#FF855D] border border-[#B24C2B]/30 rounded-2xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer shadow-2xs"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 bg-[#B24C2B] hover:bg-[#9E4F36] disabled:opacity-50 text-white rounded-2xl text-xs font-bold transition-all flex items-center gap-2 shadow-md cursor-pointer"
              >
          ...
          <div
            ...
            className={`p-3.5 rounded-2xl border transition-all cursor-pointer flex items-center justify-between gap-3 ${
              browserNotificationSettings.soundEnabled
                ...
                : 'bg-[#FAF7F2]/50 dark:bg-[#26201C]/50 border-[#E5DDD3] dark:border-[#352B24]'
            }`}
          >
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <span className="text-[10px] text-[#73675B] dark:text-[#A89C90] block truncate">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#1E1917] p-5 rounded-2xl border border-[#E5DDD3] dark:border-[#352B24] shadow-xs">
          <div className="flex items-center justify-between text-xs text-[#73675B] dark:text-[#A89C90] mb-2">
        ...
        <div className="bg-white dark:bg-[#1E1917] p-5 rounded-2xl border border-[#E5DDD3] dark:border-[#352B24] shadow-xs">
          ...
          <span className="text-[10px] text-[#73675B] dark:text-[#A89C90] block mt-1">
      ...
      <div className="bg-white dark:bg-[#1E1917] rounded-3xl border border-[#E5DDD3] dark:border-[#352B24] p-4 shadow-xs space-y-4">
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap ${
                filterRead === 'all'
                  ...
                  : 'bg-[#F3EFE9] dark:bg-[#2A2320] text-[#73675B] dark:text-[#A89C90] hover:bg-[#EDE7DF]'
              }`}
            >
          ...
          <div className="flex items-center gap-3">
            <div className="relative min-w-[200px] flex-1">
              <input
                ...
                className="w-full pl-4 pr-9 py-2 bg-[#FAF7F2] dark:bg-[#26201B] border border-[#E5DDD3] dark:border-[#352B24] rounded-xl text-xs text-[#2D2A26] dark:text-[#FAF6F2] outline-none focus:border-[#B24C2B]"
              />
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pt-2 border-t border-[#F3EFE9] dark:border-[#2D2723] text-xs">
          <span className="text-[#73675B] dark:text-[#A89C90] text-[11px] font-bold shrink-0 ml-1">
            تصنيف الإشعار:
          </span>
          <button
            type="button"
            ...
            className={`px-2.5 py-1 rounded-lg transition-all ${
              filterType === 'all'
                ...
                : 'text-[#73675B] dark:text-[#A89C90] hover:bg-[#F3EFE9] dark:hover:bg-[#2A2320]'
            }`}
          >
            الكل
          </button>
      ...
      <div className="bg-white dark:bg-[#1E1917] rounded-3xl border border-[#E5DDD3] dark:border-[#352B24] overflow-hidden shadow-xs">
        {filteredNotifications.length > 0 ? (
            ...
            {filteredNotifications.map((notif) => (
              ...
              >
                ...
                <div className="flex items-start gap-4 flex-1">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-[#2A2320] border border-[#E5DDD3] dark:border-[#352B24] flex items-center justify-center shrink-0 shadow-xs">
                  ...
                  <div className="space-y-1.5 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {!notif.read && (
                        <span className="px-2 py-0.5 bg-[#B24C2B] text-white text-[10px] font-bold rounded-full">
                          جديد
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-3 pt-1 text-[11px] text-[#8C7E72] dark:text-[#73675B]">
                ...
                <div className="flex items-center gap-2 sm:self-center shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#F3EFE9] dark:border-[#2D2723]">
                  {!notif.read && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-[#F3EFE9] dark:bg-[#2A2320] hover:bg-[#EDE7DF] dark:hover:bg-[#352C27] text-[#73675B] dark:text-[#A89C90] text-xs font-bold rounded-xl transition-colors flex items-center gap-1 cursor-pointer"
                      title="تعليم كمقروء"
                    >
                  ...
                  {notif.actionTab && onNavigateTab && (
                    <button
                      ...
                      className="px-4 py-1.5 bg-[#B24C2B] hover:bg-[#9E4F36] text-white text-xs font-bold rounded-xl shadow-xs transition-all flex items-center gap-1.5 cursor-pointer"
                    >
          ...
          <div className="p-12 text-center space-y-4">
            <div className="w-16 h-16 rounded-full bg-[#FAF7F2] dark:bg-[#26201B] flex items-center justify-center mx-auto text-gray-300 dark:text-gray-600">
              <Bell className="w-8 h-8" />
            </div>
            <h4 className="text-base font-bold text-[#2D2A26] dark:text-[#FAF6F2]">
              لا توجد إشعارات مطابقة للبحث أو التصفية الحالية
            </h4>
            <p className="text-xs text-[#73675B] dark:text-[#A89C90] max-w-md mx-auto">
          ...
          <div className="bg-white dark:bg-[#1E1917] rounded-3xl border border-[#E5DDD3] dark:border-[#352B24] max-w-lg w-full p-6 shadow-2xl space-y-5">
            ...
            <form onSubmit={handleSendBroadcast} className="space-y-4 text-xs">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#F3EFE9] dark:border-[#2D2723]">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 bg-[#B24C2B] hover:bg-[#9E4F36] text-white font-bold rounded-xl shadow-md transition-all flex items-center gap-2 cursor-pointer"
                >
                  <Send className="w-4 h-4" />
