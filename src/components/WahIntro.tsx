...
export default function WahLogoIntro({ onEnter }: WahLogoIntroProps) {
    ...
    const handleLogoClick = async () => {
        ...
        // بعد ثانيتين، ندخل على سيل من الأكواد
        setTimeout(() => {
            setStage('matrix');
        ...
        // بعد 5 ثواني إجمالية من الرعب، نقلبها كوميدي
        setTimeout(() => {
            setStage('roast');
                ...
                <div className="relative z-10 text-center space-y-6 px-4">
                    ...
                    <h1
                        className="
                            ...
                            tracking-widest
                            text-[#9a6a35]
                            drop-shadow-[0_0_20px_rgba(154,106,53,0.25)]
                        "
                    >
                    ...
                    <p className="text-2xl text-[#241b14] font-bold">
                        تم رصد محاولة اختراق لجهازك من عنوان IP:{' '}
                        <span className="text-[#9a6a35] font-mono">
                            {ipAddress}
                        </span>
                    </p>
    ...
    // 2. شاشة الماتريكس وسحب البيانات
    if (stage === 'matrix') {
        return (
            <main
                className="
            ...
            >
                <div
                    className="
                        absolute inset-0
                        bg-[radial-gradient(circle_at_center,rgba(85,122,79,0.06)_0,transparent_100%)]
                        pointer-events-none
                    "
                />
                    ...
                    {matrixLogs.map((log, index) => (
                        <p
                            ...
                            className="
                                ...
                                tracking-wider
                                text-[#557a4f]
                                drop-shadow-[0_0_5px_rgba(85,122,79,0.25)]
                            "
                        >
                            {'>'} {log}
                        </p>
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div
                    className="
                        absolute inset-0
                        opacity-[0.035]
                        bg-[linear-gradient(to_right,#9a6a35_1px,transparent_1px),linear-gradient(to_bottom,#9a6a35_1px,transparent_1px)]
                        bg-[size:30px_30px]
                    "
                />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center">
                <div
                    className="
                        ...
                        tracking-widest
                        text-[#9a6a35]
                        shadow-[0_0_15px_rgba(154,106,53,0.08)]
                    "
                >
                ...
                >
                    ...
                    <div
                        className="
                            ...
                            border-[#9a6a35]/40
                            bg-white
                            shadow-[0_20px_60px_rgba(70,45,20,0.12)]
                            transition-all
                            duration-500
                            group-hover:rotate-0
                            group-hover:scale-105
                            group-hover:border-[#9a6a35]
                            group-hover:shadow-[0_0_80px_rgba(154,106,53,0.25)]
                        "
                    >
                        <img
                            ...
                            className="
                                ...
                                filter
                                drop-shadow-[0_0_10px_rgba(154,106,53,0.3)]
                            "
                        />
                    </div>
                </button>
                ...
                <div className="mt-10 text-center space-y-2">
                    <p
                        ...
                        "
                    >
                        اضغط هنا للتحقق من هويتك ودخول{' '}
