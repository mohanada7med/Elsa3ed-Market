      ...
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-stone-900 dark:text-stone-100 flex items-center gap-2">
            <MessageSquare className="w-6 h-6 text-amber-600 dark:text-primary-hover" />
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {conv.productTitle && (
                        <div className="flex items-center gap-1 text-[11px] text-amber-700 dark:text-primary-hover mb-0.5 truncate">
        ...
        <div className={`flex-1 flex flex-col bg-white dark:bg-stone-900 ${!selectedConv ? 'hidden md:flex' : 'flex'}`}>
          {selectedConv ? (
                      ...
                      {selectedConv.productTitle && (
                        <p className="font-semibold text-stone-900 dark:text-stone-100 truncate">
                          ...
                          {selectedConv.productPrice && (
                            <span className="text-amber-700 dark:text-primary-hover font-bold mr-2">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-stone-50/40 dark:bg-stone-900/40">
              <div className="w-16 h-16 rounded-2xl bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-primary-hover flex items-center justify-center mb-4 shadow-xs">
