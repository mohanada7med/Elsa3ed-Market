      ...
      <div className="relative z-10 mx-auto flex min-h-[680px] max-w-[1500px] items-center px-5 py-16 sm:px-8 lg:px-12 lg:py-20">
        <div className="w-full max-w-3xl">
          ...
          <motion.div
            ...
            className="mt-9 grid max-الكود بعد تحويل كل النصوص للعامية المصرية الصعيدية الدارجة والمناسبة لطبيعة المنصة:
...
export const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
          ...
          >
            <img
              src="[https://res.cloudinary.com/kuana1nl/image/upload/v1788832698/WAH/heritage-places/alexan-pasha-palace/dclassic-2026-08-21-02083951477127237e_1788832673058_bzeh.jpg](https://res.cloudinary.com/kuana1nl/image/upload/v1788832698/WAH/heritage-places/alexan-pasha-palace/dclassic-2026-08-21-02083951477127237e_1788832673058_bzeh.jpg)"
              alt=""
              className="h-full w-full object-cover object-center opacity-80 dark:opacity-40 filter brightness-110"
            />
          </motion.div>
          ...
          <div
            ...
            aria-hidden="true"
          >
            <svg className="h-full w-full" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)">
              <defs>
                <pattern
                  id="wahHeroHeritagePattern"
                  width="56"
          ...
          <div className="relative z-10 mx-auto flex min-h-[680px] max-w-[1500px] items-center px-5 py-16 sm:px-8 lg:px-12 lg:py-20">
            <div className="w-full max-w-3xl">
              ...
              <motion.div
                ...
                className="mb-6"
              >
                <WAHBadge className="h-3.5 w-3.5 text-[#9a6a35]" icon="{<Sparkles" size="md" variant="terracotta" />}
            >
                «كل الصعيد في مكان واحد: سوق أصلي · ريلز وفيديوهات · حكايات وتراث»
              </WAHBadge>
            </motion.div>
            ...
            >
              أول مكان يجمع حلاوة الصعيد كلها.. من{' '}
              <span className="font-bold text-[#9a6a35]">
                سوق وه لشغل الإيد والحرف الأصلية، لريلز وفيديوهات ولاد البلد، لحد توثيق حكاياتنا وتراثنا القديم
              </span>
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>سوق متكامل: نقّي واشتري على طول، ادفع بأمان، وحاجتك هتوصل لحد باب بيتك</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#9a6a35]/15 text-[#9a6a35]">
                  <Film className="h-3.5 w-3.5" />
                </span>
                <span>فيديوهات ع الطبيعة من قلب الورش، الأماكن، وخبايا الصعيد</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[#9a6a35]/15 text-[#9a6a35]">
                  <Landmark className="h-3.5 w-3.5" />
                </span>
                <span>حكايات وأماكن من الصعيد هتعيش جواها</span>
              </div>
            </motion.div>
