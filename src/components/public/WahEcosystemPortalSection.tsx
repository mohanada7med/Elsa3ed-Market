  ...
  const portals = [
    {
      ...
      tagline: 'خريطة النيل والمعالم الحية',
      desc: 'استكشف محافظات جنوب مصر من الفيوم وبني سويف حتى أسوان والنوبة عبر خريطة تفاعلية نابضة بالحياة.',
      badge: 'التفاعلي',
      page: 'map' as const,
    ...
    },
    {
      ...
      desc: 'دليل تفصيلي لكل محافظة: الفيوم، بني سويف، المنيا، أسيوط، سوهاج، قنا، الأقصر، أسوان، والوادي الجديد.',
    ...
    },
    {
      ...
      desc: 'توثيق معابد الكرنك، دندرة، إدفو، دير المحرق، قصور المنيا الخديوية، وجبانات أسوان وعمارة النوبة.',
    ...
    },
    {
      ...
      desc: 'مستودع الروايات الشفاهية: مربعات ابن عروس، سيرة الهلالية، أساطير النيل والجبل، وتاريخ القرى والنجوع.',
      badge: 'أرشيف شفاهي',
    ...
    },
    {
      ...
      desc: 'تعرّف على وجوه الصعيد الحقيقية؛ أسطوات الحرف، رواة الحكايات، الشعراء، وفناني التراث الأصلاء.',
    ...
    },
    {
      ...
      desc: 'العيش الشمسي البلدي، الفايش الصعيدي الأصيل بالسمسم، الكشك المنياوي، وملوخية الصعيد المجففة.',
      badge: 'وصفات وأسرار',
      page: 'food' as const,
    ...
    },
    {
      ...
      desc: 'موسم كسر القصب، مولد سيدي عبد الرحيم القنائي، مهرجان التحطيب السنوي بالأقصر، وتعامد الشمس.',
      badge: 'أجندة حية',
    ...
    },
    {
      ...
      desc: 'تسوق منتجات حقيقية أصلية مضمونة من ورش قنا وأسوان وسوهاج، بدفع آمن وشحن لكافة محافظات مصر.',
