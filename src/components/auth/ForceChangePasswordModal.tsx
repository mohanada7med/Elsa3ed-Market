...
export const ForceChangePasswordModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="bg-white/95 dark:bg-[#121210]/98 rounded-3xl border border-black/10 dark:border-white/10 max-w-lg w-full p-6 sm:p-8 space-y-6 shadow-2xl overflow-hidden relative backdrop-blur-2xl text-espresso dark:text-cream">
        ...
        <div className="flex items-center gap-4 border-b border-black/10 dark:border-white/10 pb-5">
          ...
          <div>
            <h3 className="font-black text-xl text-espresso dark:text-cream">تعيين كلمة مرور شخصية</h3>
        ...
        <div className="p-3.5 bg-black/[0.03] dark:bg-cream/[0.03] rounded-2xl border border-black/5 dark:border-white/5">
          <p className="text-xs text-black/75 dark:text-white/75 leading-relaxed font-medium">
            مرحباً بك يا <strong className="text-espresso dark:text-cream">{currentUser.name || currentUser.username}</strong>. لقد سجلت الدخول بكلمة مرور مؤقتة. لحماية حسابك، يرجى تعيين كلمة مرور جديدة خاصة بك.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div>
            <label className="block font-bold text-espresso dark:text-cream mb-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-10 py-3.5 bg-black/[0.02] dark:bg-cream/[0.03] border border-black/10 dark:border-white/10 rounded-2xl outline-none focus:border-primary dark:focus:border-primary text-xs font-mono text-left text-espresso dark:text-cream placeholder:text-black/35 dark:placeholder:text-white/35 transition-all focus:ring-2 focus:ring-primary/10"
                dir="ltr"
              />
          ...
          <div>
            ...
            {newPassword && (
              <div className="mt-2 space-y-1">
                <div className="flex gap-1 h-1.5 w-full bg-black/5 dark:bg-cream/5 rounded-full overflow-hidden">
                ...
                <div className="flex justify-between items-center text-[10px] text-black/50 dark:text-white/50 px-0.5">
                  <span>مستوى الأمان: <strong className="text-espresso dark:text-cream">{strength.label}</strong></span>
