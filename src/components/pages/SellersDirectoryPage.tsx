      ...
      <div className="bg-gradient-to-r from-[#943310] to-[#78280a] rounded-3xl p-6 sm:p-10 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <p className="text-xs sm:text-sm text-amber-100/90 leading-relaxed">
            تواصل مباشرة مع الحرفيين وشيوخ الصنعة في قنا وسوهاج وأسوان والأقصر وأسيوط والمنيا. تسوق منتجاتهم الأصلية وادعم استمرار هذا الفن التراثي.
          </p>
          ...
          <div className="pt-2">
            <div className="relative max-w-md">
              <input
                ...
                className="w-full pl-4 pr-10 py-2.5 bg-white text-gray-900 rounded-xl text-xs sm:text-sm outline-none shadow-md placeholder-gray-400"
              />
