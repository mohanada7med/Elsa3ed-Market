            ...
            <div>
              ...
              <div className="mt-10 flex max-w-2xl items-start gap-5">
                ...
                <p className="text-sm leading-8 text-foreground-secondary sm:text-base">
                  ناس الصعيد هما روحه وحراسه؛ من شيوخ الصنعة اللي ورثوها كابر عن كابر، لأدباء وشعراء حكوا حكاوي البلاد بحسها الأصيل.. متوثقين بسيرتهم العطرة وأثرهم اللي عايش وسطينا.
                </p>
              </div>
            </div>
