    ...
    return (
      <div className="min-h-screen bg-[#FAF7F2] dark:bg-[#110E0C] flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-sm font-bold text-[#73675B]">جاري تحميل توثيق المعلم...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#FAF7F2] dark:bg-[#110E0C] flex items-center justify-center p-6 text-center">
        <div>
          ...
          <p className="text-sm text-[#73675B] mb-4">لم نتمكن من العثور على بيانات هذا المعلم التراثي</p>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-[#1E1917] rounded-3xl p-6 border border-[#E5DDD3] dark:border-[#352B24]">
              <h3 className="text-base font-bold mb-4 flex items-center gap-2 text-[#241E1A] dark:text-[#FAF6F2]">
                <Info className="w-4 h-4 text-[#B24C2B]" />
                <span>دليل الزيارة والاستكشاف</span>
              </h3>

              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start gap-3 p-3 rounded-xl bg-[#FAF7F2] dark:bg-[#26201B]">
                  <MapPin className="w-4 h-4 text-[#B24C2B] shrink-0 mt-0.5" />
                  <div>
                    <span className="font-bold block text-[#73675B]">الموقع الجغرافي:</span>
                    <span className="font-semibold text-[#241E1A] dark:text-[#FAF6F2]">
            ...
            <div className="bg-white dark:bg-[#1E1917] rounded-3xl p-6 border border-[#E5DDD3] dark:border-[#352B24]">
              <h3 className="text-base font-bold mb-3 flex items-center gap-2 text-[#241E1A] dark:text-[#FAF6F2]">
                <Hammer className="w-4 h-4 text-[#B24C2B]" />
